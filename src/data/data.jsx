const data = {
  ...
  srp: {
    ...
    mainInfo: [
      {
        name: 'some info',
        text: 'Sirocco Global је настао из предузетништва и великог искуства својих оснивача у сектору транспорта и логистике, нудећи нова решења на националном и међународном тржишту у областима консалтинга, отпреме и логистике.',
        img: 'url/img',
      },
      {
        name: 'some info',
        text: 'Као своју примарну мисију да понуди иновативна и конкурентна решења у вези са увозом-извозом робе, било друмским, железничким, поморским или ваздушним путем, Sirocco Global пружа услуге оријентисане на клијенте фокусиране ',
        img: 'url/img',
      },
      {
        name: 'some info',
        text: 'Sirocco Global – Од аналитике потрошње до набавке до набавке: стекните увиде који се могу применити, смањити трошкове и обезбедити усклађеност',
        img: 'url/img',
      },
    ],
    additionalInfo: [
